                            ...
                            <div className="hero__info-content">
                                ...
                                <div className="hero__info-right">
                                    <div className="hero__info-item">
                                        ...
                                        />
                                        <span className="hero__info-text">+xx (0) xxx/xxx-xxxx</span>
                                    </div>
                                    <div className="hero__info-item">
                                        <img
                                            ...
                                            className="hero__info-contact-icon"
                                        />
                                        <span className="hero__info-text">yyyy@xxxx.com</span>
                                    </div>
                                    <div className="hero__info-item">
                                        <img
                                            ...
                                            className="hero__info-contact-icon"
                                        />
                                        <span className="hero__info-text">Talblick xxx, Siegen</span>
                                    </div>
                                </div>
                            </div>
                        </div>
